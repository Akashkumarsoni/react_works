import { Avatar, Button, Checkbox, InputBase, Menu, MenuItem, Modal, Typography } from "@mui/material";
  ...
  return (
    ...
    <div className="postbox">
      <div className="upperarea">
        ...
        <div>
          ...
          >
            ...
            <MenuItem onClick={openedit} id={props.ids}>Edit</MenuItem>
      ...
      <div className="postcontnt">
        ...
        />
        <SendOutlinedIcon id={props.ids} onClick={commentit} sx={{ margin: "5px 5px", cursor: "pointer" }} />
      </div>
    </div>
    </>
  );
